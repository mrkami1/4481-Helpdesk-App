        ...
        <div className="privacy">
            ...
            <ul>
                ...
                <li>
                    ...
                    gifs, pixel tags, and single-pixel gifs) that permit Help Desk, for example,
            ...
            <p>Help Desk may use Personal Data for the following purposes:</p>
            <ul>
                <li>
                    <p>
            ...
            <p>
                Help Desk will retain Your Personal Data only for as long as is necessary for the
            ...
            <p>
                Help Desk will also retain Usage Data for internal analysis purposes. Usage Data
            ...
            <p>
                Your information, including Personal Data, is processed at Help Desk's operating
            ...
            <p>
                Help Desk will take all steps reasonably necessary to ensure that Your data is
            ...
            <p>
                If Help Desk is involved in a merger, acquisition or asset sale, Your Personal
                Data may be transferred. We will provide notice before Your Personal Data is
                transferred and becomes subject to a different Privacy Policy.
            </p>
            <h3>Law enforcement</h3>
            <p>
                Under certain circumstances, Help Desk may be required to disclose Your Personal
                Data if required to do so by law or in response to valid requests by public
                authorities (e.g. a court or a government agency).
            </p>
            <h3>Other legal requirements</h3>
            <p>
                Help Desk may disclose Your Personal Data in the good faith belief that such
                action is necessary to:
            </p>
            <ul>
                <li>Comply with a legal obligation</li>
                <li>Protect and defend the rights or property of Help Desk</li>
            ...
            <ul>
                <li>
                    ...
                    <Link to="https://helpdesk-app-a65b2.web.app/privacy">https://helpdesk-app-a65b2.web.app/privacy</Link>
                </li>
            </ul>
        </div>
    );
